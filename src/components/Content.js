  ...
  render() {
    return (
      <div id="scroll" className="Content">
        ...
        <p className="Song-title fie">"I Don't Wanna Suffer Again", being released on February 26!</p>
        <a href="https://www.youtube.com/watch?v=Hal46x0INes"><img className="Song-image fie" src="/idwsa.webp" alt="Song Image" /></a>
