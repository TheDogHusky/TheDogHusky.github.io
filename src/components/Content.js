  ...
  render() {
    return (
      <div id="scroll" className="Content">
        ...
        <p className="Song-title fie">"I Don't Wanna Suffer Again", realeased on <a className="Song-link" rel="noreferrer" href="https://soundcloud.com/adambillard/idwsa" target="_blank">SoundCloud</a> and <a className="Song-link" href="https://youtu.be/Hal46x0INes" rel="noreferrer" target="_blank">YouTube</a>!</p>
